<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="websitebackpack.login" EnableEventValidation="false" %>
...
<body data-spy="scroll" data-target=".fixed-top">
    <form id="form1" runat="server">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.aspx">
                <img src="img/logo.png" alt="alternative"></a>
                            ...
                            <div class="text-container">
                                ...
                                <form id="contactForm" data-toggle="validator" data-focus="false">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button runat="server" onserverclick="sumit1_click" type="submit" class="form-control-submit-button">OK</button>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer-col">
                            <h4>About Page</h4>
                            <p>
                                The website we created to help backpack stores promote products and sell directly on the
                            site, was created in May 2021.
                            </p>
                        </div>
                    </div>
                    <!-- end of col -->
